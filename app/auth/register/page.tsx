...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      logger.info('User registered', { userId: data.user?.id, email: formData.email });
      setSuccess(true);
      ...
      logger.error('Unexpected registration error', err as Error);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-neutral-50 to-white px-4">
        <div className="max-w-md w-full space-y-8 text-center">
          <div className="bg-success-50 rounded-lg p-8">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-neutral-50 to-white px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className={`appearance-none relative block w-full px-3 py-2 border ${
                  errors.fullName ? 'border-danger-300' : 'border-neutral-300'
                } rounded-md placeholder-neutral-500 text-neutral-900 focus:outline-none focus:ring-primary-500 focus:border-primary-500 focus:z-10 sm:text-sm`}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                className={`appearance-none relative block w-full px-3 py-2 border ${
                  errors.confirmPassword ? 'border-danger-300' : 'border-neutral-300'
                } rounded-md placeholder-neutral-500 text-neutral-900 focus:outline-none focus:ring-primary-500 focus:border-primary-500 focus:z-10 sm:text-sm`}
                placeholder="••••••••"
              />
        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button
              ...
              className="w-full inline-flex justify-center py-2 px-4 border border-neutral-300 rounded-md shadow-sm bg-white text-sm font-medium text-neutral-500 hover:bg-neutral-50 disabled:opacity-50"
            >
